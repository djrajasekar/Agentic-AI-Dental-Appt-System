...
A conversational AI system for managing dental appointments, powered by LangGraph and Google Gemini. This project demonstrates a multi-agent architecture where specialized agents work together to handle different appointment-related tasks through natural language interactions.
